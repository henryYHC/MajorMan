	...
	if(isset($_GET['kw']) && $_GET['kw'] != '')
  	{
    	...
    	if($count > 0)
	    {
	      ...
	      {
	        echo "<div class=\"search_results\">".$row['First_name']." ".$row['Last_name']."<button class=\"btn-primary btn-xs pull-right\" onclick=\"addFriend('".$row['Registration_no']."')\">Add</button></div>";
	        $i++;
	    ...
	    {
	      echo "Please input complete first name or last name!";
	    }
	}
